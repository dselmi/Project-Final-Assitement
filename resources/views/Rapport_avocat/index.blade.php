        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">
                <img class="profile-user-img img-fluid img " src="{{asset('images/accueil.png')}}" alt="avatar"
                    style="width: 40px;"> Liste des rapports avocat
            </h1>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="example2" class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                    <thead>
                        <tr>
                        ...
                        <tr>
                          <td class="text-center">{{ $i }}</td>
                            ...
                            <td>
                                    ...
                                    <a href="{{ route('rapport_assistante.edit.index', $rapport->id) }}" class="btn btn-secondary "
                                    ...
                                    <a class="btn btn-danger delete-fiche" href="#"
                                        data-url="{{ route('rapport_assistante.delete', $rapport->id) }}">
            ...
            <div class="col col-lg-4 alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0 text-dark">Aucun rapport avocat trouvé</h6>
                    </div>
                </div>
            </div>
            @endif
...
<script>
    $(document).on('change','#fiche-accueil',function(){
        var url = "{{ route('rapport_avocat.create.index',':id') }}";
