...
<div class="row">
    <div class="col-xl-7 mx-auto">
        <h6 class="mb-0 text-uppercase">Rapport d'assistante</h6>
        <hr />
        <div class="card border-top border-0 border-4 border-primary">
            <div class="card-body p-5">
                <form id="FicheGardeForm" action="{{ route('rapport_assistante.edit.update',$rapport->id) }}" method="post" class="row g-3">
                    @csrf
                    <div class="col-md-8">
