...
<div class="block-content block-content-full ">
            ...
            <h5 class="flex-grow-1 fw-semibold my-2 my-sm-3">
                <img class="profile-user-img img-fluid img " src="{{asset('images/accueil.png')}}" alt="avatar"
                    style="width: 30px;border-radius: 50%"> Liste des rapports écoutante
            </h5>
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <a href="{{ route('rapport_ecoutante.edit.index', $rapports->id) }}" class="btn btn-secondary "
                                    ...
                                    <a class="btn btn-danger delete-fiche" href="#"
                                        data-url="{{ route('rapport_ecoutante.delete', $rapports->id) }}">
            ...
            <div class="col col-lg-4 alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0 text-dark">Aucun rapport écoutante trouvé</h6>
                    </div>
                </div>
            </div>
            @endif
...
<script>
    $(document).on('change','#fiche-accueil',function(){
        var url = "{{ route('rapport_ecoutante.create.index',':id') }}";
