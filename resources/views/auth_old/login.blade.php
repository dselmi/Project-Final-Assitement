                ...
                <form method="POST" action="{{ route('login-user') }}">
                  ...
                  <label class="form-label" for="form2Example27">Mot de passe</label>
                    ...
                    @if($errors->any())
										        ...
										        @endif
                  <div class="pt-1 mb-4">
                    <button id="login-btn" type="submit" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
  <path d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z"/>
</svg></i> Se connecter</button>
                  </div>

                  <a class="small text-muted" href="/forgotPassword">Avez-vous oublié le mot de passe?</a>
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Vous n'avez pas de compte? <a href="registration"
