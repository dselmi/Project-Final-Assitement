              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form method="POST" action="{{ route('forgotPassword') }}">
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <div class="mb-3 text-secondary"> Entrez votre adresse mail et nous vous encerrons un lien pour réinitialiser votre mot de passe.</p>
                  ...
                  <div class="pt-1 mb-4">
                    ...
                    </svg></i>Réinitialiser le mot de passe</button>
                                      </div>

                  <div> Retourner à <a href="login" class="text-decoration-none">la page de connexion</a></div>
                  <br>
