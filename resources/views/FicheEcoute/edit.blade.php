            ...
            <div class="col-xl-8 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body px-5">
                        <form id="ficheForm" action="{{ route('ecoute.edit.update',$fiche) }}" method="post" class="row g-3">
                            @csrf
                            <div class="col-md-4">
                                <label for="date" class="form-label">Date</label>
                                <input type="text" class="form-control" name="fiche_ecoute[date]" id="date" value="{{$fiche->date}}">
                            </div>
                            <div class="col-md-4">
                                <label for="lieu" class="form-label">Lieu</label>
                                <input type="text" class="form-control" name="fiche_ecoute[lieu]" id="lieu"value="{{$fiche->lieu}}">
                            </div>
                            <br><br>
                            <div class="card-title d-flex align-items-center">
                                <div><i class="bx bxs-user me-1 font-22 text-info"></i>
                                </div>
                                <h5 class="mb-0 text-info">Renseignements</h5>
                            </div>
                            <hr />
                            <div class="col-md-4">
                                <label for="first_name" class="form-label">Prénom</label>
                                <input type="text" class="form-control" name="renseignement[first_name]"
                                    id="first_name" value="{{$fiche->renseignement->first_name}}">
                            </div>
                            <div class="col-md-4">
                                <label for="last_name" class="form-label">Nom</label>
                                <input type="text" class="form-control" name="renseignement[last_name]" id="last_name" value="{{$fiche->renseignement->last_name}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <label for="date_naissance" class="form-label">Date de naissance</label>
                                <input type="text" class="form-control" name="renseignement[date_naissance]"
                                    id="date_naissance" value="{{$fiche->renseignement->date_naissance}}">
                            </div>
                            <div class="col-md-4">
                                <label for="lieu_naissance" class="form-label">Lieu de naissance</label>
                                <input type="text" class="form-control" name="renseignement[lieu_naissance]"
                                    id="lieu_naissance" value="{{$fiche->renseignement->lieu_naissance}}">
                            </div>
                            <div class="col-md-4">
                                <label for="nationality" class="form-label">Nationalité</label>
                                <input type="text" class="form-control" name="renseignement[nationality]"
                                    id="nationality" value="{{$fiche->renseignement->nationality}}">
                            </div>
                            <div class="col-md-4">
                                <label for="profession" class="form-label">Profession</label>
                                <input type="text" class="form-control" name="renseignement[profession]"
                                    id="profession" value="{{$fiche->renseignement->profession}}">
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="renseignement[level_instruction]"
                                    id="level_instruction" value="{{$fiche->renseignement->level_instruction}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="renseignement[cin_passeport]"
                                    id="cin_passeport" value="{{$fiche->renseignement->cin_passeport}}">
                            </div>
                            <div class="col-md-4">
                                <label for="phone" class="form-label">Tél/GSM</label>
                                <input type="text" class="form-control" name="renseignement[phone]" id="phone" value="{{$fiche->renseignement->phone}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="renseignement[place_residence]"
                                        id="rural"  value="{{$fiche->renseignement->place_residence}}">
                                    <label class="form-check-label" for="rural">Rural</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="renseignement[place_residence]"
                                        id="urbain" value="{{$fiche->renseignement->place_residence}}">
                                    <label class="form-check-label" for="urbain">Urbain</label>
                                </div>
                            </div>
                            <br><br>
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-info">Situation de famille et d'état civil de la victime</h5>
                            </div>
                            <hr />
                            <div class="col-md-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="situation_state_victime[state]"
                                    value="{{$fiche->stateVictime->state}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="situation_state_victime[duration_state]"
                                    id="duration_state" value="{{$fiche->stateVictime->duration_state}}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="situation_state_victime[nb_childrens]"
                                    id="nb_childrens" value="{{$fiche->stateVictime->nb_childrens}}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="situation_state_victime[check_other_people]" value="{{$fiche->stateVictime->check_other_people}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="situation_state_victime[other_people]"
                                    id="other_people" value="{{$fiche->stateVictime->other_people}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox"
                                        name="situation_state_victime[situation_victime][]" value="{{$fiche->stateVictime->situation_victime}}">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" name="situation_state_victime[maladies]"
                                    id="maladies" value="{{$fiche->stateVictime->maladies}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-8">
                                <label class="form-label">Vie commune avec l’auteur présumé des violences au moment des
                                    faits ?</label><br>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="situation_state_victime[living_together_with_times_events]" value="{{$fiche->stateVictime->living_together_with_times_events}}">
                                    <label class="form-check-label">Oui</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                            ...
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-info">Situation de famille et renseignements d'état civil de
                                    l'auteur présumé</h5>
                            </div>
                            <hr />
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="situation_agresseur[first_name]"
                                    id="first_name" value="{{$fiche->agresseur->first_name}}">
                            </div>
                            <div class="col-md-4">
                                <label for="last_name" class="form-label">Nom </label>
                                <input type="text" class="form-control" name="situation_agresseur[last_name]"
                                    id="last_name" value="{{$fiche->agresseur->last_name}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <label for="age" class="form-label">Age </label>
                                <input type="text" class="form-control" name="situation_agresseur[age]" id="age" value="{{$fiche->agresseur->age}}">
                            </div>
                            <div class="col-md-4">
                                <label for="nationality" class="form-label">Nationalité </label>
                                <input type="text" class="form-control" name="situation_agresseur[nationality]"
                                    id="nationality" value="{{$fiche->agresseur->nationality}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <label for="profession" class="form-label">Profession </label>
                                <input type="text" class="form-control" name="situation_agresseur[profession]"
                                    id="profession" value="{{$fiche->agresseur->profession}}">
                            </div>
                            <div class="col-md-4">
                                <label for="level_instruction" class="form-label">Niveau d’instruction </label>
                                <input type="text" class="form-control" name="situation_agresseur[level_instruction]"
                                    id="level_instruction" value="{{$fiche->agresseur->level_instruction}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="situation_agresseur[relation]"
                                    id="relation" value="{{$fiche->agresseur->relation}}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Tél / GSM </label>
                                <input type="text" class="form-control" name="situation_agresseur[phone]" value="{{$fiche->agresseur->phone}}">
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-8">
                                <label class="form-label">Adresse postale</label>
                                <textarea class="form-control" name="situation_agresseur[address]" rows="3" value="{{$fiche->agresseur->address}}"></textarea>
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="situation_agresseur[state]"
                                    value="{{$fiche->agresseur->state}}">
                                    <label class="form-check-label">Célibataire</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="situation_agresseur[state]"
                            ...
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-info">Renseignements sur le ou les faits déclenchant la démarche
                                </h5>
                            </div>
                            <hr />
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" class="form-control" name="violence_verbale[autreex]" id="autre" value="{{$fiche->violence_verbale->autreex}}">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    value="{{$fiche->violence_verbale->times}}">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" name="violence_verbale[place]" value="{{$fiche->violence_verbale->place}}">
                            </div>
                            <div class="col-md-8">
                                <label class="form-label">Depuis quand ?</label>
                                <input type="text" class="form-control" name="violence_verbale[from_when]" value="{{$fiche->violence_verbale->from_when}}">
                            </div>
                            <div class="col-md-8">
                                <label class="form-label">Par qui?</label>
                                <input type="text" class="form-control" name="violence_verbale[by_who]" value="{{$fiche->violence_verbale->by_who}}">
                            </div>
                            @break
                            @case('Harcelement')
                            <div class="card-title text-center">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" name="harcelement[other]" rows="3" value="{{$fiche->harcelement->other}}"></textarea>
                            </div>
                            <div class="col-md-9">
                                <label class="form-label">Cela arrive une ou plusieurs fois :</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="harcelement[times]"
                                    value="{{$fiche->harcelement->times}}">
                                    <label class="form-check-label">Par jour</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="harcelement[times]"
                            ...
                            <div class="col-md-8">
                                <label class="form-label">En quel(s) lieu(x) :</label>
                                <input type="text" class="form-control" name="harcelement[place]" value="{{$fiche->harcelement->place}}">
                            </div>
                            <div class="col-md-8">
                                <label class="form-label">Depuis quand ?</label>
                                <input type="text" class="form-control" name="harcelement[from_when]" value="{{$fiche->harcelement->from_when}}">
                            </div>
                            <div class="col-md-8">
                                <label class="form-label">Par qui?</label>
                                <input type="text" class="form-control" name="harcelement[by_who]" value="{{$fiche->harcelement->by_who}}">
                            </div>
                            @break
                            ...
                            <div class="col-md-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox"
                                        name="violence_psychologiques[type][]" value="{{$fiche->violence_psychologique->times}}">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="violence_psychologiques[times]" value="jour">
                                    <label class="form-check-label">Par jour</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="violence_psychologiques[times]" value="semaine">
                                    <label class="form-check-label">Par semaine</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="violence_psychologiques[times]" value="mois">
                                    <label class="form-check-label">Par mois</label>
                                </div>
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="violence_economiques[times]" value="jour">
                                    <label class="form-check-label">Par jour</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="violence_economiques[times]" value="semaine">
                                    <label class="form-check-label">Par semaine</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="violence_economiques[times]" value="mois">
                                    <label class="form-check-label">Par mois</label>
                                </div>
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                                <label class="form-label">Je suis contrainte à subir : des scénarios
                                    pornographiques:</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label">Oui il l’insulte</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
