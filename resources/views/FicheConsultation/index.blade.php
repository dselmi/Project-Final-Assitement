...
<div class="block-content block-content-full ">
            ...
            <h5 class="flex-grow-1 fw-semibold my-2 my-sm-3">
                <img class="profile-user-img img-fluid img " src="{{asset('images/accueil.png')}}" alt="avatar"
                    style="width: 30px;border-radius: 50%"> Liste des fiches de consultation
            </h5>
        ...
        <div class="card-body">
            ...
            <div class="col col-lg-4 alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
                <div class="d-flex align-items-center">
                    <div class="font-35 text-dark"><img class="profile-user-img img-fluid img"
                        src="{{asset('images/info.png')}}" alt="avatar" style="width: 40px;">
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0 text-dark">Aucune fiche de consultation trouvée</h6>
                    </div>
                </div>
            </div>
            @endif
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Suppression fiche de consultation</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Voulez vous supprimer cette fiche de consultation</p>
            </div>
...
<script>
    $(document).on('change','#fiche-accueil',function(){
        var url = "{{ route('consultation.create.index',':id') }}";
